...
function getUser_twitter_facebook_post_settings($user_id)

	{

		return $this->CI->User_Model->getUser_twitter_facebook_settings_info($user_id);
    ...
    */}
...

    {
		...
		$tag_id= $row[$i]->tag_id;
			...
			$top_user=$this->CI->db->query("SELECT COUNT(*) AS totaltagused,gb_tags_relation.geo_location_id,gb_tags_relation.tag_id,gb_geo_location.region_name,gb_geo_location.city FROM gb_tags_relation 
