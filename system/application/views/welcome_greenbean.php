...
<script type="text/javascript">
		...
		$(".login_box").fancybox({ 'zoomSpeedIn': 300, 'zoomSpeedOut': 300, 'overlayShow': true ,'frameWidth':400,'frameHeight':160,'hideOnContentClick': false}); 
		});
	</script>
...
?> - <?
 ...
 ?>  
 <a href="tags/<?=$tag_array[$i]['tag_name']?>/0" id="<?=$tag_array[$i]['tag_id']?>"> #<?=$tag_array[$i]['tag_name']?></a>
 <? }}?>
 </span>
 </p>
