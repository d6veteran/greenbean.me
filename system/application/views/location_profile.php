...
?>
<div class="leaderboard-li">
  <p> <?=$rank_array_bytags[$i]['rank'];?> in <a href="<?=base_url()?>tags/<?=$rank_array_bytags[$i]['label']?>/0"><?=$rank_array_bytags[$i]['label']?></a></p>
</div>
<? } ?>
...
<div class="leaderboard-inner">
<div class="leaderboard-li">
  <p><?=$this->functions->bean_earnd_bylocation($locations_id);?> Beans Earned</p>
</div>
<div class="leaderboard-li">
  <p><?=$this->functions->bean_requested_bylocation($locations_id);?> Bean Requests</p>
</div>
</div>
