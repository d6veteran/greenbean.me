...
class TwitterOAuth {
  ...
  function TwitterUpdateStatus($status='') {
...
$this->oAuthRequest('https://twitter.com/statuses/update.xml', array('status' => $status), 'POST');
// $this->updateStatus($status, $in_reply_to_status_id =0, $format ='xml');
}
