...
TinyMCE_Popup.prototype.openBrowser = function(element_id, type, option) {
	...
	else
	{
		...
		openChild('abc.php','_upload');
	}
		
		//eval("tinyMCEPopup.windowOpener." + cb + "(element_id, url, type, window);");
};

// mani ADDED openChild function for pop up image uploader (opens abc.php)
function openChild(file,window) {
    childWindow=open(file,window,'resizable=no,width=300,height=200');
